...
from mothernet.evaluation.baselines.nam_custom.models.activation import ExU, LinReLU
...
class FeatureNN(Model):
    ...
    def __init__(
        ...
        *,
        ...
        if isinstance(self.config.hidden_sizes, tuple):
            self.config.hidden_sizes = list(self.config.hidden_sizes)
        ...
        ## Last Linear Layer
        layers.append(nn.Linear(in_features=hidden_sizes[-1],
